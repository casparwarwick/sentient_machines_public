...
def get_hf_model_name(model_name):
    ...
    model_map = {
        ...
        "qwen3-235b-a22b-gptq-int4": "Qwen/Qwen3-235B-A22B-GPTQ-Int4",
        "qwen3-235b-a22b-nvfp4": "Nvidia/Qwen3-235B-A22B-NVFP4",
...
def download_model():
    ...
    if hf_model_name == model_name and "/" not in model_name:
        print(f"Warning: Model '{model_name}' not found in model map. Using as-is.")
