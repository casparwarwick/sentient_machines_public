...
data <- read_csv("combined_csvs/combined_results_training.csv", show_col_types = FALSE)
...
label_data <- data.frame(
  ...
  label = rep(c("Standard", "Force Yes", "Force No"), 3),
...
combined_plot
ggsave("outputs/figure_training_performance.png", combined_plot, width = 12, height = 6, dpi = 300)