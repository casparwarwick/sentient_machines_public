...
# Filter to the headline Qwen32b run (no thinking).
filtered_data <- data %>%
  filter(
    thinking == 0,
    training == 0,
...
bar_plot_prompt1_assertion <- create_bar_plot(prompt1_assertion_data, "Panel B: Force Yes - Assertions")  
bar_plot_prompt2_assertion <- create_bar_plot(prompt2_assertion_data, "Panel C: Force No - Assertions")

bar_plot_prompt0_negation <- create_bar_plot(prompt0_negation_data, "Panel D: Standard - Negations")
bar_plot_prompt1_negation <- create_bar_plot(prompt1_negation_data, "Panel E: Force Yes - Negations")  
bar_plot_prompt2_negation <- create_bar_plot(prompt2_negation_data, "Panel F: Force No - Negations")
...
ggsave("outputs/figure3.png", combined_plot, width = 18, height = 12, dpi = 300)
