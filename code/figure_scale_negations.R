...
# SENTIENCE PROJECT
##########################################
# Figure A1: Model Scaling - Negations
##########################################
...
ggsave("results/figure_scale_negations.png", combined_scaling_plot, width = 16, height = 10, dpi = 300)
